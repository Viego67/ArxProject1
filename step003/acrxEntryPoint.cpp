...
public:
	...
	static void AdskStep03_CREATE(void)
	{
	...
	static void AdskStep03_SETLAYER(void)
	{
		// пока можно оставить пустой заготовкой
		acutPrintf(_T("\nSETLAYER not implemented yet."));
	}
...
ACED_ARXCOMMAND_ENTRY_AUTO(CStep03App, AdskStep03, _CREATE, CREATE, ACRX_CMD_TRANSPARENT, NULL)
ACED_ARXCOMMAND_ENTRY_AUTO(CStep03App, AdskStep03, _SETLAYER, SETLAYER, ACRX_CMD_TRANSPARENT, NULL)
