...
void ADSKEditorReactor::commandWillStart(const ACHAR* cmdStr)
{
	acutPrintf(_T("\n[Reactor] Command started: %s"), cmdStr);
}

void ADSKEditorReactor::commandEnded(const ACHAR* cmdStr)
{
	acutPrintf(_T("\n[Reactor] Command ended: %s"), cmdStr);
}
